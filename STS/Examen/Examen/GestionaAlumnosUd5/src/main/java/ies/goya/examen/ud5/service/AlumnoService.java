...
import ies.goya.examen.ud5.repository.RepositorioEmail;
...
public class AlumnoService {
	...
	public Alumno crearAlumno(String nombre ,String apellido) {
		Alumno x = new Alumno(nombre,apellido);
		repositorioAlumno.save(x);
		return null;
	}
	
	public Alumno enlazarCorreo(Long id ,String email) {
		//Email x = new Email(email);
		//System.out.println(x);
		//repositorioEmail.save(x);
	 Alumno t=	repositorioAlumno.findById(id).orElse(null);
	 System.out.println(t);
		Email x = new Email(email,t);
		repositorioEmail.save(x);
		return null;
	}
	
	public Alumno crearCompleto(String nombre ,String apellido,String email) {
		...
		Email h = new Email(email,a);
		repositorioEmail.save(h);
		return null;
	}
	...
	public Alumno borrarEmailDeAlumno(Long id ) {
		repositorioAlumno.findById(id);
		
		return null;
	}
	
	public Email listaEmail(Long id) {
		repositorioEmail.findById(id);
